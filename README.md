...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r memadmin
```
### package install
...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r memadmin -p
```
...
```
git clone --depth=1 https://github.com/Websoft9/docker-memadmin
cd docker-memadmin
...
You can point your browser to: *`http://Instance's Internet IP:9090`*  
...
| --- | --- | --- | --- |
| memadmin-server | 9090 | Web-GUI database management tool | Y |
## Documentation

[MemAdmin Administrator Guide](https://support.websoft9.com/docs/memadmin)

## Enterprise Support

If you want to get our Enterprise Support to ensure high availability of applications, you can subscribe our [MemAdmin Enterprise Support](https://apps.websoft9.com/memadmin) 
